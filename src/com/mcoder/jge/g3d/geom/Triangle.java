...
public record Triangle(Vertex... vertices) {
    public void clip(Plane plane, LinkedList<Triangle> clipped) {
        ...
        if (insideSize == 3)
            ...
            clipped.add(new Triangle(inside[0], Vertex.lerp(inside[0], outside[0], t1),
            ...
            clipped.add(new Triangle(inside[0], inside[1], common));
            clipped.add(new Triangle(inside[1], common.copy(), Vertex.lerp(inside[1], outside[0], t2)));
        }
    }
